...
class CoulombSoftMatterPotential(SoftMatterPotential):
    ...
    This class is (currently) only implemented for a three-dimensional cube.
    ...
    def get_gradient(self, positions):
        ...
        return self._get_two_particle_position_space_gradient(*separation) + self._get_two_particle_fourier_space_gradient(*separation)

    def _get_two_particle_position_space_gradient(self, separation_x, separation_y, separation_z):
        """Return the position-space part of the Ewald sum of the two-particle gradient."""
    ...
    def _get_two_particle_fourier_space_gradient(self, separation_x, separation_y, separation_z):
        """Return the Fourier-space part of the Ewald sum of the two-particle gradient"""
