...
class ToroidalLeapfrogMediator(NonreversibleMediator):
    ...
    def _get_candidate_configuration(self):
        ...
        candidate_positions = get_shortest_vectors_on_torus(self._positions + self._step_size * beta *
        ...
        for _ in range(self._number_of_integration_steps - 1):
            ...
            candidate_positions = get_shortest_vectors_on_torus(candidate_positions + self._step_size * beta *
                                                                self._kinetic_energy.get_gradient(candidate_momenta))
