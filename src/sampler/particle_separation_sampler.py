...
class ParticleSeparationSampler(Sampler):
    ...
    def get_observation(self, momenta, positions, potential):
        ...
        """
        return [np.linalg.norm(get_shortest_vectors_on_torus(positions[i] - positions[j])) for i in
    ...
    def output_sample(self, sample, temperature_index):
        ...
        """
        self._write_sample_to_file(sample, f"temperature_{temperature_index:02d}_sample_of_particle_separations.npy")
    ...
    def get_sample(self, temperature_index):
        ...
        numpy.ndarray
            The sample generated by the Markov chain.
        """
        return self._read_sample_from_file(f"temperature_{temperature_index:02d}_sample_of_particle_separations.npy")
