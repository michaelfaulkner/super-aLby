...
class PositionSampler(Sampler, metaclass=ABCMeta):
    ...
    def output_sample(self, sample, temperature_index):
        ...
        """
        self._write_sample_to_file(sample, f"temperature_{temperature_index:02d}_sample_of_positions.npy")
    ...
    def get_sample(self, temperature_index):
        ...
        numpy.ndarray
            The sample generated by the Markov chain.
        """
        return self._read_sample_from_file(f"temperature_{temperature_index:02d}_sample_of_positions.npy")
